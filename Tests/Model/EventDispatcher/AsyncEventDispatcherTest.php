...
class AsyncEventDispatcherTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->driverMock =
            $this->getMockForAbstractClass('BDK\AsyncDispatcherBundle\Model\EventDispatcher\AsyncEventDriverInterface');
    ...
    public function testDisptacherInterface()
    {
        ...
        $this->assertInstanceOf('BDK\AsyncDispatcherBundle\Model\EventDispatcher\AsyncEventDispatcherInterface', $dispatcher);
    }
